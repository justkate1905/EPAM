...
import epam.collections.customLinkedList.CustomLinkedList;
...
public class CustomListsTest {
    ...
    @Test
    public void testThatWeCanAddElementToTheEnd() throws Exception {
        fillList();
        list.add("wasd");
        assertThat(list.get(6),is("wasd"));
    }
    @Test
    public void testThatWeCanAddElementInRandomPlace() throws Exception {
        fillList();
        list.add(0,"wasd");
        assertThat(list.get(0),is("wasd"));
    }
    @Test
    public void testThatWeCanCreateArrayFromList() throws Exception {
        fillList();
        String[] a = new String[list.size()];
        list.toArray(a);
        assertThat(a[0], is(list.get(0)));
    }
